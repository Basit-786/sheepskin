...
const Products = () => {
  ...
  return (
    <div className="px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
      <div id="services" className="flex flex-col py-6 lg:py-10">
        ...
        <div className="w-full grid grid-cols-2 xs:grid-cols-4 gap-4 lg:gap-20 mt-3 md:mt-6 max-w-[1100px]">
          <div className="w-full flex flex-col items-center justify-center gap-4">
            <div className="w-full bg-light-white rounded-full p-9 xs:p-6 md:p-12 cursor-pointer hover:bg-secondary group transition duration-200">
              <Image
            ...
            <h3 className="text-md md:text-xl font-medium text-center">Sheep</h3>
          </div>
          <div className="w-full flex flex-col items-center justify-center gap-4">
            <div className="w-full bg-light-white rounded-full p-9 xs:p-6 md:p-12 cursor-pointer hover:bg-secondary group transition duration-200">
              <Image
            ...
            <h3 className="text-md md:text-xl font-medium text-center">Reindeer</h3>
          </div>
          <div className="w-full flex flex-col items-center justify-center gap-4">
            <div className="w-full bg-light-white rounded-full p-9 xs:p-6 md:p-12 cursor-pointer hover:bg-secondary group transition duration-200">
              <Image
            ...
            <h3 className="text-md md:text-xl font-medium text-center">Daniel Deer</h3>
          </div>
          <div className="w-full flex flex-col items-center justify-center gap-4">
            <div className="w-full bg-light-white rounded-full p-9 xs:p-6 md:p-12 cursor-pointer hover:bg-secondary group transition duration-200">
              <Image
            ...
            <h3 className="text-md md:text-xl font-medium text-center">Medical</h3>
          </div>
        </div>
      </div>
