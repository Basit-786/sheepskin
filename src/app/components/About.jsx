...
import { onceTrue, slideInFromBottom, slideInFromLeft } from "../utils/motion";
    ...
    <section>
      <div className="px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
          <motion.div variants={slideInFromBottom(0.25,140)} initial={"hidden"} viewport={onceTrue} whileInView={"visible"}  className="relative h-64 overflow-hidden rounded-lg sm:h-80 lg:order-last lg:h-full">
            <Image
              alt=""
              src="/about.jpeg"
          ...
          <motion.div variants={slideInFromLeft(0.5)} initial={"hidden"} viewport={onceTrue} whileInView={"visible"}  className="lg:py-12">
