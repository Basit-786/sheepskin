    ...
    <div className="max-w-[1000px] flex flex-col items-center justify-center mx-auto px-4 py-8 lg:py-16">
     <div className="flex flex-col md:flex-row justify-between gap-5 md:gap-10 w-full">
      ...
      <div className="mt-5 md:mt-10">
        ...
        <p className="my-2.5 md:my-4 text-[#666666] text-[16px]">{t("description")}</p>

        <h2 className="text-2xl font-bold sm:text-3xl leading-[110%] my-2.5 md:my-4 mt-4 md:mt-6">
          {t("charcteristicTitle")}
        </h2>
        <p className="my-2.5 md:my-4 text-[#666666] text-[16px]">
          {t("characteristicContent")}
        </p>
        <h2 className="text-3xl font-bold sm:text-4xl leading-[110%] my-3">
          {t("processTitle")}
        </h2>
        <p className="my-2.5 md:my-4 text-[#666666] text-[16px]">{t("processContent")}</p>
        <h2 className="text-2xl font-bold sm:text-3xl leading-[110%] my-2.5 md:my-4 mt-4 md:mt-6">
          {t("applicationTitle")}
        </h2>
        ...
        <p className="my-2.5 md:my-4 text-[#666666] text-[16px]">{t("qualityContent")}</p>
